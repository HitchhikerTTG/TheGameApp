...
<p>Numer aktywnego turnieju: <?=esc($config['activeTournamentId'])?></p>
<p>Numer aktywnego turnieju: <?=esc($config['activeCompetitionId'])?></p>
<p>Nazwa aktywnego turnieju: <?=esc($config['activeTournamentName'])?></p>
<?
?>