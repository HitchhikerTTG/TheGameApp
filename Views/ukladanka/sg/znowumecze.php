            ...
            <div class="accordion-item">
                <h2 class="accordion-header" id="heading<?= $match['ApiID']; ?>">
                    <button class="accordion-button collapsed px-1" type="button" data-bs-toggle="collapse" data-bs-target="#collapse<?= $match['ApiID']; ?>" aria-expanded="false" aria-controls="collapse<?= $match['ApiID']; ?>">
                        <?= $naszCzas; ?> | <?= $homeTeamName ?> vs <?= $awayTeamName ?> | <?= isset($match['typy']['HomeTyp']) ? "Twój typ: {$match['typy']['HomeTyp']}:{$match['typy']['AwayTyp']}" : 'Wytypuj'; ?>
                    </button>
                </h2>
                            ...
                            <div class="col">
                                ...
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <tbody>
                                        <tr>
                                        <td>Liczba typów dla tego meczu:</td><td> <?= $match['liczbaTypow']; ?></td></tr>
                                        ...
                                        <tr><td>Najpopularniejszy typ: </td><td><?= $match['podsumowanieTypow']['mostPopularType']; ?> (<?=$match['podsumowanieTypow']['mostPopularTypeCount']?>x)  </td></tr>
