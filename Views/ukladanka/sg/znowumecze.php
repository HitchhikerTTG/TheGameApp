                                    ...
                                    <form action="/theGame/nowyZapisTypu" method="post" class="betting-form">
                                        ...
                                        <div class="row">
                                            <div class="col team h_<?= $match['details']['home_team']['id']; ?>">
                                                ...
                                                <div class="row">
                                                    <div class="col zminusem"><button type="button" class="btn btn-outline-secondary minus">-</button></div>
                                                    <div class="col zplusem"><button type="button" class="btn btn-outline-secondary plus">+</button></div>
                                                </div>
                                            </div>
                                            <div class="col team a_<?= $match['details']['away_team']['id']; ?>">
                                                ...
                                                <div class="row">
                                                    <div class="col zminusem text-center"><button type="button" class="btn btn-outline-secondary minus">-</button></div>
                                                    <div class="col zplusem text-center"><button type="button" class="btn btn-outline-secondary plus">+</button></div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <div class="row">
                                                    <div class="col">
                                                        <input type="checkbox" class="golden-game-checkbox" id="goldenGame<?= $match['Id']; ?>" name="goldenGame" data-game-id="<?= $match['Id']; ?>" value="1" <?= $match['Id'] == $usedGoldenBall ? 'checked' : ''; ?> <?= $usedGoldenBall !== 0 && $usedGoldenBall !== $match['Id'] ? 'disabled' : ''; ?>>
