...
Jedna mała sprawa. To jest idea zasad, która obowiazywała przez ostatnie lata. Może się jeszcze troszkę (delikatnie) aktualizować.
...
<figure><table>
<thead>
<tr><th>Za co</th><th>Ile punktów</th></tr></thead>
<tbody><tr><td>Za wynik totolotkowy</td><td>1 punkt</td></tr><tr><td>Za dokładny wynik</td><td>3 punkty</td></tr><tr><td>Za pytanie dodatkowe</td><td>A to już zależy od pytania. Od 1 do 3 punktów</td></tr></tbody>
</table></figure>
</div></div>
<div class="row"> <div class="col">
<h3>Złota piłka**</h3>
...
<p>Zarejestruj się;-) Możesz to zrobić zakładając nowe konto.</p>
</div></div>

<div class="row"> <div class="col">
<h3>A co jeśli więcej niż jeden gracz ma taką samą liczbę punktów?</h3>
<p>Zasady wedle ważności</p>
<ol>
<li>Liczba poprawnie wytypowanych dokładnych wyników</li>
<li>Liczba poprawnie wytypowanych wyników totolotkowych</li>
<li>Liczba poprawnie odpowiedzianych pytań</li>

</ol>
</div></div>
<div class="row"> <div class="col">
<h3>Pytania?</h3>
<p>Jeśli masz pytania - daj znać. Mailem, messengerem albo osobiście. Mam dziwne wrażenie, że jeśli będziesz mieć pytanie, to mnie znajdziesz. Aż tak dobrze się nie ukrywam.</p>
<p>[*] 11 na 11 + 4sędziów</p>
<p>[**] w przeciwieństwie do złotego mercedesa, złota piłka naprawdę jest złota</p>
</div>
</div>
</div>