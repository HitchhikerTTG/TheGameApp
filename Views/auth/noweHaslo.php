...
<div class="row">
	<div class="col">
		...
		?>
    	<form action="<?= site_url('auth/newPassSave') ?>" method="post" accept-charset="utf-8">
		<?= csrf_field() ?>
			<input type="hidden" name="uniid" value="<?=$uniid?>">
  		<div class="form-group col-md-8 mb-3">
  				<label class="bmd-label-floating">Twoje hasło</label>
  			<input type="password" class="form-control" name="password" id="Password">
  			<small id="titleHelp" class="form-text text-muted">Używaj managera haseł. <br>To hasło musi mieć przynajmniej 7 znaków.<br> I prosze, niech to nie bedzie 1234567. <br>To hasło już zająłem. Podobnie jak qwerasdf. <br> 1234qwer też <br>Liczę na Twoją kreatywność (i nie, nie podglądam).</small>
